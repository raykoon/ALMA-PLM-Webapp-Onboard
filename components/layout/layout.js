...
export default function Layout(props) {
  ...
  let nameObjList={
     ...
     'Ecommerce':[
        {name:'Storefront'},
        {name:'Products',push: "/reports/linesheets/products"},
        {name:'Orders'},
        {name:'Reports'},
        {name:'Inventory'},
     ...
     'Profile / Settings':[
      ...
      {name:'Billing & Subscriptions (Admin)',icon:'iconfont icon_subnav4'},
  ...
  const [navBar, setNavbar] = useState([
    {
      img: <i style={{fontSize:'24px',marginLeft:'-2px',marginRight:'10px'}} className="iconfont icon_sqLayout5"></i>,
      title: 'My Dashboard',
      push: '/dashboard',
    },
    {
      img: <i style={{
        ...
        fontSize:'24px',
        marginLeft:'-2px'
      }} className="iconfont icon_sqLayout6"></i>,
      title: 'Seasons & Styles',
      push: '/styles',
    },
    {
      img: <i style={{fontSize:'24px',marginLeft:'-2px',marginRight:'11px'}} className="iconfont icon_sqLayout3"></i>,
      title: 'Buy & Order',
      push: '/suppliers',
    },
    {
      img: <i style={{fontSize:'24px',marginLeft:'-2px',marginRight:'11px'}} className="iconfont icon_sqLayout4"></i>,
      title: 'Ecommerce',
      push: '/reports/linesheets',
    },
    {
      img: <i style={{fontSize:'24px',marginLeft:'-2px',marginRight:'11px'}} className="iconfont icon_sqLayout7"></i>,
    ...
    },
    {
      ...
      className="iconfont icon_sqLayout8"></i>,
    ...
    },
    {
      img: <i 
      style={{fontSize:'24px',marginLeft:'-2px',marginRight:'11px'}}
      className="iconfont icon_stylesSet"></i>,
      ...
      >
        ...
        <div className={styles.navBarLogo}>
          ...
          {ShowNav && (
            ...
            >
              <i style={{fontSize:20}} className="iconfont icon_sqLayout"></i>
            </div>
          )}
        </div>
        {/* Navi List */}
            ...
            return (
              <div
                ...
                className={classNames(
                  ...
                  (router.pathname.indexOf(ele.push) !== -1 || router.pathname.indexOf(ele.copyTitle) !== -1) && index != 0
              ...
              >
                <div 
                  className={`${moveName==ele.title? styles.newShowNav:''} ${(moveName==ele.title && router.pathname.indexOf(ele.push) !== -1)?styles.newIconActive:''}`}
                style={{ width: '100%',fontSize:'16px',letterSpacing:'0',height:'40px',paddingLeft:'11px',borderTopLeftRadius:'5px',
                borderBottomLeftRadius:'5px',
                background:(moveName==ele.title && router.pathname.indexOf(ele.push) !== -1)?'#292929':'',
...
{
        moveName && <div className={styles.rightBoxList} style={{
          left:ShowNav?'270px':'64px',
        }}>
          <div style={{fontSize:'12px',}}>{moveName}</div>
          <div>
          {
            nameObjList[moveName] && nameObjList[moveName]?.map((res,index)=>{
               return <div
               key={index}
                onClick={()=>{
                  if(res.push){
               ...
               style={{
                ...
                {
                  res.icon && <span><i style={{
                    fontSize:'24px',
                    marginRight:'5px',
                    // position:'relative',
                    // top:'2px'
                  }} className={res.icon}></i></span>
                }
...
{ShowNav ? (
          ...
          <div
            className={`${styles.newBoxJs} ${moveName=='My account'?styles.newBoxJs1:''}`}
            onMouseEnter={()=>{
