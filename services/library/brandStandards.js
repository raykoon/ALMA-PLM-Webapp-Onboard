...
//查询布料库列表
export const fabricsList = (data) => axios.post(`/styles/labels/list`, data);
export const labelsList = (data) => axios.post(`/styles/labels/list`, data);


//查询布料库详细
export const fabricsDetails = (id) => axios.get(`/styles/labels/${id}`);

//布料库批量删除
export const fabricsDelete = (data) => axios.post(`/styles/labels/batch/${data.toString()}`);


//新增favrics   /styles/fabrics

export const fabricsAdd = (data) => axios.post(`/styles/labels/`,data);


///styles/fabrics/update 布料库修改
export const fabricsUpdate = (data) => axios.post(`/styles/labels/update/`,data);
